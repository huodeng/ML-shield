...
def backdoor(net,isuplord,dataset):
    ...
    ws_printer.print("后门攻击：")
    ws_printer.print("未使用隐私保护")
    

    # 设置随机种子
    set_random_seed(42)  # 使用命令行参数中的随机种子
    ...
    if args.load_local:
        ...
        model1.load_state_dict(torch.load(basic_model_path), strict=True)
        ...
        for epoch in range(args.epochs):
            ...
            # save model 
            torch.save(model1.state_dict(), basic_model_path)
